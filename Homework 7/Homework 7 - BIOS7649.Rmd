...
p_value_number_cancer <- DMR_cancer[DMR_cancer$pval < 10e-5,]
...
mset_cancer <- M_cancer[c("cg08880423","cg14488592","cg00156072","cg12298140"),]

```

There are `r q_value_number_cancer` differentially methylated positions with q-values $\leq$ 0.10. There are `r nrow(p_value_number_cancer)` differentially methylated positions between cancer and non-cancer samples. Of these `r nrow(p_value_number_cancer)`, `r hypo` are hypomethylated and `r hyper` are hypermethylated. 
...
plotCpg(mset_cancer,cpg = c("cg08880423","cg14488592",
                            "cg00156072","cg12298140"),
...
# for a p-value cutoff of 10e-5.
p_value_number_sex <- DMR_sex[DMR_sex$pval < 10e-5,]
...
# Selecting top 4 p-values from M
mset_sex <- M_sex[c("cg10013343","cg15479068","cg17220960","cg11403874"),]

```

There are `r q_value_number_sex` differentially methylated positions with q-values $\leq$ 0.10. There are `r nrow(p_value_number_sex)` differentially methylated positions between males and females. Of these `r r nrow(p_value_number_cancer)`, `r hypo_sex` are hypomethylated and `r hyper_sex` are hypermethylated. 
...
plotCpg(mset_sex,cpg = c("cg10013343","cg15479068",
                            "cg17220960","cg11403874"),
...
results_gset_sex <- cbind(pData(gset_sex)$predictedSex, pData(gset_sex)$Sex)
...
# Determining number of hyper and hypomethylation positions due to sex
# for a p-value cutoff of 10e-5.
p_value_number_sex2 <- DMR_sex2[DMR_sex2$pval < 10e-5,]
...
# Selecting top 4 p-values from M
mset_sex2 <- M_sex2[c("cg10013343","cg15479068","cg17220960","cg11403874"),]
...
# Plotting beta values for males and females. 
plotCpg(mset_sex2,cpg = c("cg10013343","cg15479068",
                            "cg17220960","cg11403874"),
