...
The above figure shows boxplots of the sample counts. Because a **SeqExpressionSet** was created the output from the boxplot should be on the log scale already. The medians are not the same for all 
...
EDASeq::biasPlot(loess_within,"gc",log = T,ylim = c(2,4))
